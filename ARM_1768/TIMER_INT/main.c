...
{
	/*
	Timer 0 Prescale counter register
	*/
	LPC_TIM0->PC = 0x00;
	/*
	...
	*/
	...
	BIT[0] MR0I 1 Interrupt on MR0: an interrupt is generated when MR0 matches the value in the TC.
	*/
	LPC_TIM0->MCR |= (1<<0);
...
void TIMER0_IRQHandler(void)
{
	...
	BIT[0] MR0 Interrupt Interrupt flag for match channel 0
	First check about which interrupt is occuring.
	It may be from MR0 Match or it may be from MR1 etc...
	*/
